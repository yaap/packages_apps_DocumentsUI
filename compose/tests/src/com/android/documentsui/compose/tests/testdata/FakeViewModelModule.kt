...
import com.android.documentsui.compose.data.DataModule
import com.android.documentsui.compose.data.DocumentsProviderDataSource
import com.android.documentsui.compose.tests.testdata.FakeDocumentsProviderDataSource
import dagger.Binds
...
abstract class FakeViewModelModule {
    @Binds
    @Singleton
    abstract fun bindDocumentsProviderDataSource(
        fakeDocumentsProviderDataSource: FakeDocumentsProviderDataSource
